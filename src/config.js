...
export const config = {
  ...
  bridgeRestartDelayMs: parseInt(value("BRIDGE_RESTART_DELAY_MS", "500"), 10),
  ...
  // ── LM Studio (native v1 API — privacy-first, stateful) ──
  ...
  lmstudioApiToken: value("LMSTUDIO_API_TOKEN", ""),
}
